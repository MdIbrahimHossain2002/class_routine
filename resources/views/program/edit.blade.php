                ...
                <div class="card-body">
                    <form action="{{ route('program.update', $program->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-6">
                                <label for="title" class="col-form-label">Program <span class="text-danger">*</span></label>
                                <input type="text" name="title" id="title" class="form-control square-input" placeholder="Enter faculty name" value="{{$program->title}}" style="width: 100%;">
                                @error('title')
                                <small class="form-text text-danger">
                                    {{ $message }}
                                </small>
