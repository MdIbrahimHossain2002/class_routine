    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('course.importSubmit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row mb-3">
                            ...
                            <div class="form-group col mb-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="file" id="file" class="form-control square-input" placeholder="Enter course list">
                                </div>
                            </div>
                        </div>
