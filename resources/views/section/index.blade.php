      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $section->section }}</td>
            ...
            <form action="{{ route('section.destroy', $section->id) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Are You Sure You want To Delete?')">
              @csrf
              @method('DELETE')
